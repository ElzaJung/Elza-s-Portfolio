...
| :--- | :--- | :--- |
| [EnviroVest](./envirovest) | Data Preparation, NLP Analysis | Built a real-time ESG risk rating platform using an automated pipeline processing reports, news, and filings to generate risk scores and dashboard visuals to support informed investor decisions. | `beautifulsoup4`, `Selenium`, `PostgreSQL`, `GoogleNews API`, `yahoofinance API`, `Gemini LLM`, `pandas`, `numpy`, `react`|
...
| Evaluating the Generalizability and Age-Related Reliability of Emotion Recognition Models (working on it) | python, scikit-learn, opensmile, matplotlib, seaborn, pandas, numpy, HuggingFace | .. |
---
